...
namespace El_Chapo
{
    public class ListCatcheurs
    {
        ...
        public int DisplayListOfCatcheur(int indexOfCatcheur)
        {
            ...
            foreach (Catcheur i in TheListOfCatcheur)
            {
                ...
                Console.WriteLine("\n");
                return indexOfCatcheur;
            }

            Combat.catcheur = indexOfCatcheur;
            return Combat.catcheur;
                 
        }

        internal void DisplayListOfCatcheur()
        {
